                        ...
                        <?php foreach($page_list as $data){ ?>
                            <?php if(allowed_page_fields($data["page_type"],"extension",$all_page_type)){ ?>
                                ...
                                <?php if(allowed_page_fields($data["page_type"],"ffs",$all_page_type)){ ?>
                                    <li <?=(isset($data_type) && isset($relation_id) && $data_type=="page" && $relation_id==$data["page_id"])?'class="active"':''?>><a href="<?php echo $base_url; ?>ffs/page/<?=$data["page_id"]?>"><i class="fa fa-file-text-o"></i> <?=$data["page_name"]?></a></li>
                                <?php } ?>
                                <?php if(allowed_page_fields($data["page_type"],"ppg",$all_page_type)){ ?>
                                    <li <?=(isset($data_type) && isset($relation_id) && $data_type=="page" && $relation_id==$data["page_id"])?'class="active"':''?>><a href="<?php echo $base_url; ?>ppg_grapes/page/<?=$data["page_id"]?>"><i class="fa fa-file-text-o"></i> <?=$data["page_name"]?></a></li>
                                <?php } ?>
                                <?php if(allowed_page_fields($data["page_type"],"pipvg",$all_page_type)){ ?>
                                    <li <?=(isset($data_type) && isset($relation_id) && $data_type=="page" && $relation_id==$data["page_id"])?'class="active"':''?>><a href="<?php echo $base_url; ?>pipvg/page/<?=$data["page_id"]?>"><i class="fa fa-file-text-o"></i> <?=$data["page_name"]?></a></li>
                                <?php } ?>
                            <?php } ?>
                        <?php } ?>
                    </ul>
