    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <?php if(isset($access_msg)){ ?>
                ...
                <div class="text-center"><a class="btn btn-success" href="<?=base_url()?>login"><?=_l("Login Now",$this)?></a> <a class="btn btn-info btn-lg" href="<?=base_url()?>register"><?=_l("Register New",$this)?></a></div>
            <?php } ?>
