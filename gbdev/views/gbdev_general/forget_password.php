...
<div class="container" style="background: #f9f9ff; padding-top: 50px;padding-bottom: 50px;margin-bottom: 70px;margin-top: 70px;">
    <div class="panel">
          ...
          <!--  <h3><?=_l("Return password",$this)?></h3>-->
            ...
            <form class="" action="" method="post" id="post_form">
                ...
                <div class="form-group text-center">
                    <a href="#" onclick="$(this).closest('form').submit()" class="genric-btn primary-border"><?=_l('Submit',$this);?></a>
                </div>
