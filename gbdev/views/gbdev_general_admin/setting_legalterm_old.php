...
<ul class="nav nav-tabs">
    ...
    <li role="presentation"><a href="<?php echo base_url()?>admin/settings/gdpr"><?php echo _l('GDPR',$this)?></a></li>
    <li role="presentation"class="active"><a href="<?php echo base_url()?>admin/settings/legalterm"><?php echo _l('Legal term',$this)?></a></li>
</ul>
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <a href="<?=$base_url?>edit_setting_legalterm/0" class="btn btn-success"><?=_l("Create a New",$this)?></a>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <?php if(!(isset($data["valid_from"]))){echo( isset($data["valid_from"]));?>
                                            <a href="<?=$base_url?>edit_setting_legalterm<?=isset($data["setting_legalterm_id"])?"/".$data["setting_legalterm_id"]:""?>/0" class="btn btn-primary btn-sm" title="<?=_l('Edit',$this)?>"><i title="<?=_l('Edit',$this)?>" class="fa fa-pencil"></i></a>
                                            <a href="<?=$base_url?>delete_legalterm_by_id<?=isset($data["setting_legalterm_id"])?"/".$data["setting_legalterm_id"]:""?>/0" class="btn btn-danger btn-sm" title="<?=_l('Delete',$this)?>"><i title="<?=_l('Delete',$this)?>" class="fa fa-trash-o"></i></a>
                                            <a href="<?=$base_url?>activate_legalterm_by_id<?=isset($data["setting_legalterm_id"])?"/".$data["setting_legalterm_id"]:""?>" class="btn btn-success btn-sm" title="<?=_l('Activate',$this)?>"><i title="<?=_l('Activate',$this)?>" class="fa fa-file-text-o"></i> <?=_l('Activate',$this)?></a>

                                        <?php }else {?>
                                            <a href="<?=$base_url?>edit_setting_legalterm<?=isset($data["setting_legalterm_id"])?"/".$data["setting_legalterm_id"]:""?>/1" class="btn btn-success btn-sm" title="<?=_l('Preview',$this)?>"><i title="<?=_l('Preview',$this)?>" class="fa fa-file-text-o"></i> <?=_l('Preview',$this)?></a>
                                        <?php } ?>
                                  </td>
                                </tr>
                            <?php } ?>
