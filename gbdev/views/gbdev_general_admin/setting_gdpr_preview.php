            ...
            <div class="col-lg-12 col-md-12 col-xs-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title"><a href="<?=$base_url?>settings/gdpr" class="btn btn-success"><?=_l("Back",$this)?></a></h3>
                    </div>
                    <?php
                    mk_hpostform();
                    ?>
                    <div class="card-body">
                        <div class="form-group ">
                            <label class="control-label col-lg-2">  <?php echo _l('Legal term basic data preview',$this); ?></label>
                            <div class="col-lg-10">
                                ...
                                <div class="tab-content nav-languages">
                                    <?php foreach ($languages as $item) { ?>
                                        <div role="tabpanel" class="tab-pane" id="langtab<?php echo $item["language_id"]?>">
                                            <?php
                                            mk_htexteditorpreview("data[options][".$item["language_id"]."][message]",_l('All auto message headers',$this)." (".'<img src="'.base_url().$item["image"].'" style="width:18px;"> '.$item["language_name"].")",isset($options[$item["language_id"]])?$options[$item["language_id"]]["message"]:"");
                                            ?>
                                        </div>
                                    <?php } ?>
