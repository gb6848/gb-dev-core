                    ...
                    <table id="Grid" class="table table-bordered table-striped">
                        ...
                        <?php foreach($data_list as $data){ ?>
                            <tr class="gradeX">
                                ...
                                <td>
                                    <a href="<?=$base_url?>edit<?=$page?>/<?=$data["extension_id"]?>" class="btn btn-primary btn-sm" title="<?=_l('Edit',$this)?>"><i title="<?=_l('Edit',$this)?>" class="fa fa-edit"></i></a>
                                    <a href="<?=$base_url?>delete<?=$page?>/<?=$data["extension_id"]?>/<?=isset($data_type)?"/".$data_type:""?><?=isset($relation_id)?"/".$relation_id:""?>" class="btn btn-danger btn-sm btn-delete" title="<?=_l('Delete',$this)?>"><i title="<?=_l('Delete',$this)?>" class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
