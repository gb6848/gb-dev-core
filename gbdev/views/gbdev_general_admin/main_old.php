        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="custom-bar-chart">
                    <ul class="y-axis" style="padding: 0px!important;">
                    ...
                    <?php if(isset($statistic) && count($statistic)!=0){ ?>
                        ...
                        foreach($statistic as $item){
                            ...
                            <div class="bar  <?=$class?>" style="margin-left: 10px!important;">
                                <div class="title">
                                    <?php echo date("D",$item["statistic_date"]); ?><br>
                                    <?php echo date("d.m",$item["statistic_date"]); ?><br>
                                    <?php echo date("Y",$item["statistic_date"]); ?>
                                </div>
                                <div class="value tooltips" data-original-title="<?php echo $item["visitors"]?>&nbsp;<?=_l("Visitors",$this)?> <?php echo $item["visits"]?>&nbsp;<?=_l("Visits",$this)?>" data-toggle="tooltip" data-placement="top"><?php echo round(($item["visitors"]*100)/$statistic_max_visitors); ?>%</div>
                            </div>
                        <?php
                        $index= $index +1;
                        } ?>
